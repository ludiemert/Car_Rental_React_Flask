    ...
    <table>
        <tr>
            <td style="width: 50%; text-align: center;">
                <img src="img_proj/01_web_project.png" style="width: 90%;" alt="01_web_project">
...
<div align="center">
    <table>
        <tr>
            <td style="width: 50%; text-align: center;">
                <img src="img_proj/03_web_project_locad.png" style="width: 90%;" alt="03_web_project_locad">
                <p style="margin-top: 5px;">web_project_locad</p>
            </td>
            <td style="width: 50%; text-align: center;">
                <img src="img_proj/04_API_127.0.0.1_5000_api_carros.png" style="width: 90%;" alt="04_API_127.0.0.1_5000_api_carros">
                <p style="margin-top: 5px;">API_127.0.0.1_5000_api_carros</p>
            </td>
        </tr>      
    </table>
</div>
